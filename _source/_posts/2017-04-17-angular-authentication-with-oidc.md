...
tweets:
  - "Build a simple Angular 6 app and add authentication with @okta!"
  - "Have you heard about OpenID Connect (OIDC) and how you can use it for authentication with @okta? This tutorial shows you how to do it in a 20 minutes →"
---
...
* May 7, 2018: Updated to use Angular CLI 6.0, Angular 6.0, and Okta Sign-In Widget 2.8.0. See the code changes in [okta-angular-openid-connect-example#10](https://github.com/oktadeveloper/okta-angular-openid-connect-example/pull/16) and the article changes in [okta.github.io#2029](https://github.com/okta/okta.github.io/pull/2029).
